/**
 * This file, alder_vector_option.h, is part of alder-vector.
 *
...
#ifndef alder_vector_alder_vector_option_h
#define alder_vector_alder_vector_option_h
...
typedef struct {
    ...
    bstring logfilename;
} alder_vector_option_t;

int alder_vector_option_init(alder_vector_option_t *o, struct gengetopt_args_info *a);
void alder_vector_option_free(alder_vector_option_t *o);

__END_DECLS


#endif /* alder_vector_alder_vector_option_h */
