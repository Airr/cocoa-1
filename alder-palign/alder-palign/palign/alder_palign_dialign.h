/**
 * This file, alder_palign_dialign.h, is part of alder-palign.
 *
...
#ifndef alder_palign_alder_palign_dialign_h
#define alder_palign_alder_palign_dialign_h
...
typedef struct scr_matrix alder_palign_dialign_scr_matrix_t;
...
typedef struct seq alder_palign_dialign_seq_t;
...
typedef struct seq_col alder_palign_dialign_seq_col_t;
...
typedef struct prob_dist alder_palign_dialign_prob_dist_t;
...
typedef struct seq_part alder_palign_dialign_seq_part_t;
...
typedef struct diag alder_palign_dialign_diag_t;
...
typedef struct simple_diag_col alder_palign_dialign_simple_diag_col_t;
...
typedef struct gt_node alder_palign_dialign_gt_node_t;
...
typedef struct diag_col alder_palign_dialign_diag_col_t;
...
typedef struct diag_cont alder_palign_dialign_diag_cont_t;
...
typedef struct algn_pos alder_palign_dialign_algn_pos_t;
...
typedef struct alignment alder_palign_dialign_alignment_t;
