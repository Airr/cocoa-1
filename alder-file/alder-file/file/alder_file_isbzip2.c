/**
 * This file, alder_file_isbzip2.c, is part of alder-file.
 *
...
/**
 *  This function tests if a given file is of bzip2 format.
 *  See http://en.wikipedia.org/wiki/Bzip2 for bzip2 format.
 *
 *  @param fn file name
 *
 *  @return YES if the file is a bzip2, NO otherwise.
 */
int
alder_file_isbzip2(const char *fn)
{
    if (fn == NULL) {
