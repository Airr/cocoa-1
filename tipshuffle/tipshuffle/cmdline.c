...
const char *gengetopt_args_info_purpose = "The program tipshuffle shuffles taxa names at the tips of Newick trees\nin a Newick tree file.";

const char *gengetopt_args_info_usage = "Usage: tipshuffle [OPTIONS]... [FILES]...";
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:", long_options, &option_index);
