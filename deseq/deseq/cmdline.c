/*
  ...
  gengetopt --file-name=cmdline --unamed-opts --func-name=my_cmdline_parser --include-getopt 
...
const char *gengetopt_args_info_purpose = "The program deseq determines differentially expressed genes.";

const char *gengetopt_args_info_usage = "Usage: deseq [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --first=STRING   first samples",
  "  -s, --second=STRING  second samples",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->genome_help = gengetopt_args_info_help[2] ;
  args_info->out_help = gengetopt_args_info_help[3] ;
  args_info->first_help = gengetopt_args_info_help[4] ;
  args_info->first_min = 0;
  args_info->first_max = 0;
  args_info->second_help = gengetopt_args_info_help[5] ;
  args_info->second_min = 0;
  args_info->second_max = 0;
...
my_cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_string_field (args_info->first_given, &(args_info->first_arg), &(args_info->first_orig));
  free_multiple_string_field (args_info->second_given, &(args_info->second_arg), &(args_info->second_orig));
...
my_cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->first_given, "first", args_info->first_orig, 0);
  write_multiple_into_file(outfile, args_info->second_given, "second", args_info->second_orig, 0);
...
my_cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->genome_given)
    {
      fprintf (stderr, "%s: '--genome' ('-g') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->first_given, args_info->first_min, args_info->first_max, "'--first' ('-f')"))
     error_occurred = 1;
  
  if (! args_info->second_given)
    {
      fprintf (stderr, "%s: '--second' ('-s') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->second_given, args_info->second_min, args_info->second_max, "'--second' ('-s')"))
     error_occurred = 1;
                        ...
                        struct my_cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * first_list = NULL;
  struct generic_list * second_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVg:o:f:s:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'o':	/* output prefix.  */
          ...
          break;
        case 'f':	/* first samples.  */
        
          if (update_multiple_arg_temp(&first_list, 
          ...
          break;
        case 's':	/* second samples.  */
        
          if (update_multiple_arg_temp(&second_list, 
  ...
  update_multiple_arg((void *)&(args_info->first_arg),
    &(args_info->first_orig), args_info->first_given,
    local_args_info.first_given, 0,
    ARG_STRING, first_list);
  update_multiple_arg((void *)&(args_info->second_arg),
    &(args_info->second_orig), args_info->second_given,
    local_args_info.second_given, 0,
    ARG_STRING, second_list);

  args_info->first_given += local_args_info.first_given;
  local_args_info.first_given = 0;
  args_info->second_given += local_args_info.second_given;
  local_args_info.second_given = 0;
...
failure:
  free_list (first_list, 1 );
  free_list (second_list, 1 );
