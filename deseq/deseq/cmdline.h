...
#define MY_CMDLINE_PARSER_PACKAGE "deseq"
#endif

#ifndef MY_CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define MY_CMDLINE_PARSER_PACKAGE_NAME "deseq"
#endif
...
struct gengetopt_args_info
{
  ...
  char * genome_arg;	/**< @brief genome.  */
  char * genome_orig;	/**< @brief genome original value given at command line.  */
  const char *genome_help; /**< @brief genome help description.  */
  char * out_arg;	/**< @brief output prefix.  */
  char * out_orig;	/**< @brief output prefix original value given at command line.  */
  const char *out_help; /**< @brief output prefix help description.  */
  char ** first_arg;	/**< @brief first samples.  */
  char ** first_orig;	/**< @brief first samples original value given at command line.  */
  unsigned int first_min; /**< @brief first samples's minimum occurreces */
  unsigned int first_max; /**< @brief first samples's maximum occurreces */
  const char *first_help; /**< @brief first samples help description.  */
  char ** second_arg;	/**< @brief second samples.  */
  char ** second_orig;	/**< @brief second samples original value given at command line.  */
  unsigned int second_min; /**< @brief second samples's minimum occurreces */
  unsigned int second_max; /**< @brief second samples's maximum occurreces */
  const char *second_help; /**< @brief second samples help description.  */
