...
struct gengetopt_args_info
{
  ...
  long select_version_arg;	/**< @brief Select a version of kmer counting: 0 for automatic selction, 1 for skipping binary file creation (dsk mode with a single iteration), 2 for binary file creation (dsk mode), 3 for loading a whole input data on the memory (msk or memory streaming kmer mode), and 4 for splitting a binary file. (default='5').  */
