...
const char *gengetopt_args_info_purpose = "alder-kmer counts kmers in a data set of FASTQ sequence files.";

const char *gengetopt_args_info_usage = "Usage: alder-kmer [command] [OPTIONS]... [FILES]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "alder-kmer counts kmers exactly using DSK algorithm (Rizk et al. 2013) or\napproximately using Top-Kmer algorithm. The first argument of alder-kmer is a\ncommand: `count', `dump', or `query'. See options for each command; e.g.,\nalder-kmer count --help or --full-help.";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\ncount:",
  "  This command takes sequence files (FASTA, or FASTQ) to count kmers to create\n  a TAB file. Use command `example' for details of file formats. This command\n  runs on either topkmer-mode (default) or dsk-mode. Use option --dsk to turn\n  on dsk-mode. See section COUNT by using command `example'.",
  "      --count                   Count k-mer data  (default=off)",
  "  -k, --kmer=INT                k-mer size (same: -m/--mer-len)  (default=`1')",
  ...
  "  -o, --outfile=STRING          prefix of output files  (default=`outfile')",
  "      --outdir=DIRECTORY        output directory  (default=`.')",
  "      --nh=INT                  number of hash elements  (default=`0')",
  "      --no-partition            Skip partitioning sequence files.\n                                  (default=off)",
  "      --no-count                Skip counting.  (default=off)",
  "      --no-delete               Do not delete partition files; on with\n                                  --no-count  (default=off)",
  "\ndump:",
  "  This command takes a table file to report kmers and their occurences. Use\n  command `count' to create a table input file. It prints k-mer sequence, its\n  reverse complementary sequence (--with-reverse), the number of occurences,\n  and the index of the sequence (--with-index) for each kmer.",
  "      --report                  Report the count table  (default=off)",
  "      --summary                 Display only summary of the table\n                                  (default=off)",
  "      --fasta                   in fasta format  (default=off)",
  "      --no-tab                  Space separator  (default=off)",
  "\nquery:",
  "  This command takes a sequence (--sequence) or a set of sequences in FASTA\n  files or STDIN as input to search a count table (--tabfile) for them.",
  "      --query                   dummy  (default=off)",
  "      --sequence=sequence       Query a kmer DNA sequence",
  "\nsimulate:",
  "  This command creates a sequence data set of FASTQ or FASTA files for testing\n  alder-kmer. It runs with two modes. The two modes of simulation are for\n  testing exact counting and approximate counting. By default, it creates\n  sequence data with exact number of kmers. Use option --error-rate with\n  positive numbers ranging from 1 to 100 to simulate data in the approximate\n  counting mode.",
  "      --simulate                Simulate k-mer data  (default=off)",
  "      --maxkmer=INT < 10^8      number of kmers in a file  (default=`1000')",
  "      --format=STRING           file format  (possible values=\"fasta\",\n                                  \"fastq\", \"fa\", \"fq\", \"seq\", \"kmc\",\n                                  \"tbl\", \"tbh\", \"par\", \"bin\"\n                                  default=`fastq')",
  ...
  "\npartition:",
  "  This command converts a binary file to partition files. Use options --ni and\n  --np to create ni x np partition files. You can use options: --disk and\n  --memory to set automatically --ni and --np, but to use --disk and --memmory\n  you must set --ni=-1 and --np=-1. See the reference by Rizk, et al. (2013)\n  for details using option --cite.",
  ...
  "\nkmer:",
  "  This command converts a partition file to a kmer sequence file. Because\n  partition files do not have a field of kmer size, set the kmer size to use\n  this command. Use the following commands to convert the decoded kmers to a\n  dumped table.\n  $cut -f 1 outfile.dec|sort|uniq -c|awk 'BEGIN{OFS=FS=\" \"}\n  {tmp=$1;$1=$2;$2=tmp;print}' > outfile.2",
  "      --decode                  Decode a partition file  (default=off)",
  "\ntable:",
  "  This command converts partition files to a table file. Use the following\n  options: --kmer, --nh, --nthread, and provide at least one partition file as\n  an input file. A series of partition files can be used with option\n  --parfile=x; x-a-b.par is a partition file for iteration a and partition b.\n  The table size is estimated by using given partition files.",
  "      --table                   Partition file  (default=off)",
  "\nlist:",
  "  This command lists kmer sequences in a fastq file. Kmer sequences should have\n  the four letters of A, C, G, and T (a, c, g, or t). Any other characters are\n  considered to be a invalid DNA letter. Invalid characters would end a\n  sequence, and let the command restart a new sequence if there are more DNA\n  letters that follow. Available options include kmer. It does not check the\n  content of a FASTQ file, and may have side-effects if other formats are\n  provided. It reads STDIN or a file. If option --outfile is used, a file with\n  .lst extension is created instead of being sent to STDOUT",
  "      --list                    List kmers in a text file. Options: kmer,\n                                  seqlen  (default=off)",
  "\nmatch:",
  "  This command compares a table file with a set of input files or kmer count\n  files. Input can be given as either standard input or input files.",
  "      --match                   Compare a table file and input sequence data.\n                                  (default=off)",
  "      --tabfile=STRING          a table file name  (default=`outfile')",
  "\nbinary:",
  "  This command converts FASTQ sequence files to a binary sequence file. Use\n  command uncompress to decode a binary file.",
  ...
  "      --loglevel=level          Log level  (possible values=\"0\", \"1\",\n                                  \"2\", \"3\", \"4\", \"5\" default=`1')",
  ...
  "      --select-version=INT      Select a version of kmer counting: 0 for\n                                  automatic selction, 1 for skipping binary\n                                  file creation (dsk mode with a single\n                                  iteration), 2 for binary file creation (dsk\n                                  mode), 3 for loading a whole input data on\n                                  the memory (msk or memory streaming kmer\n                                  mode), 4 for splitting a binary file, 5 for\n                                  distributed reading, 7 for sequential read\n                                  with CAS encoding, and 8 for space saving\n                                  algorithm.  (possible values=\"0\", \"1\",\n                                  \"2\", \"3\", \"4\", \"5\", \"7\", \"8\"\n                                  default=`8')",
  ...
  "  -U, --upper-count=INT <= 4294967295\n                                maximum count  (default=`65535')",
  "      --size=INT                hash size  (default=`1')",
  "      --threads=INT>=1          number of threads  (default=`1')",
  "      --output=STRING           prefix of output files  (default=`outfile')",
  ...
  "      --nsplit=INT              split binary files  (default=`1')",
  "      --use-seqfile             Use FASTQ or FASTA  (default=off)",
  "      --binfile=STRING          prefix of binary files  (default=`outfile')",
  "      --parfile=STRING          prefix of partition files  (default=`outfile')",
  "      --error-initial=INT       number of initial random sets  (default=`1')",
  "      --error-rate=INT (1..100) error rate in per cent  (default=`0')",
  "      --error-iteration=INT     number of sets with errors  (default=`1')",
  "      --error-duplicate=INT     max number of sets with the same errors\n                                  (default=`1')",
  "      --dsk                     Turn on DSK mode  (default=off)",
  "\nassess:",
  "  This command assesses errors and accuracy of an approximated count table.",
  "      --assess                  assess command  (default=off)",
  "      --save-all                Save deleted keys  (default=off)",
  "\nview:",
  "  This command converts binary files to human readable text.",
  "      --view                    view command  (default=off)",
  "      --fastq                   in fastq format  (default=off)",
  "      --release                 Release mode  (default=on)",
  "\nexit:",
  "  The alder-kmer exit 0 on success, and >0 if an error occurs. The command\n  `simulate' returns 0 if all of the Kmers occur only once and --nf=1,\n  otherwise >0. If option --nf is set to 2 or more, then the exit status from\n  `simulate' is invalid.",
  "      --exit                    dummy  (default=off)",
  "\nexamples:",
  "  The alder-kmer can take files of different formats with each command.\n\n  *** FILE FORMAT ***\n\n  FASTA: See http://en.wikipedia.org/wiki/FASTA_format for the format. Command\n  `simulate' can create fasta-format files.\n\n  FASTQ: See http://en.wikipedia.org/wiki/FASTQ_format for the format. Command\n  `simulate' can create fastq-format files.\n\n  TAB: The command `count' creates a table file, which contains a list of\n  entries, of which each consists of a kmer, its occurence, and the index. The\n  index value could be used to search the table for a particular kmer. Another\n  command named `table' can create a table file from a partition file.\n\n  BIN: A set of input sequence files is converted to a .bin file. A binary file\n  tends to be smaller in size, which allows alder-kmer to read a whole input in\n  each iteration more quickly than read sequence files.\n\n  PAR: This is a binary file format for a partition. See Rizk et al. (2013) for\n  details of partitions. A file of the format contains kmer sequences of the\n  same kmer size. Commands `count'. `simulate', and `partition' can create\n  partition files.\n\n  DEC: This is a text file format of partition files. It simply prints one kmer\n  per line.\n\n  KMC: This is a binary file with kmers and their counts. Kmers may not be\n  unique, which is different from a table file. An entry in the binary file\n  consists of kmers in 64-bit value and count in 32-bit value. The `count'\n  command with topkmer mode can create .kmc files with option --save-all. The\n  `match' command takes .kmc files as input to compare them with a exactly\n  counted table file.\n\n  *** FILE CONVERSION ***\n\n  Commands can convert input files to some output files.\n\n  count   : FASTQ -> TABLE\n\n  dump    : TABLE -> TXT\n\n  query   : TABLE -> TXT\n\n  view    : BIN, PAR, KMC -> TXT\n\n  simulate: -> FASTQ, FASTA, SEQ\n\n  list    : FASTQ -> TXT\n\n  binary  : FASTQ -> BIN\n\n  partition: BIN -> PAR\n\n  table   : PAR -> TAB\n\n  match   : TAB ->\n\n  assess  : TAB ->\n\n  inspect : ->\n\n  *** COMMANDS ***\n\n  Use one of the commands to execute alder-kmer; `count', `query', `dump', and\n  a few more for debugging. When demontrating usages of alder-kmer in the\n  following, the first argument is a command; I omit alder-kmer. For instance,\n  to count kmer of size 1 in file a.fa you can type in the following command:\n  $ ./alder-kmer simulate > a.fq\n  $ ./alder-kmer count a.fq\n  $ ./alder-kmer dump outfile.tbl\n  T	A	513	89936814\n  C	G	487	357654460\n  Instead, we write in this tutorial as follows:\n  $ simulate > a.fq\n  $ count a.fq\n  $ dump outfile.tbl\n  Prepend the command in this tutorial with `alder-kmer' in your terminal. If\n  you need a test sequence file, then see the following section to learn how to\n  use `simulate' command, which would create sequence files.\n\n  *** COUNT ***\n\n  This command takes sequence files as input to create a table of kmer counts.\n  It runs on either topkmer-mode or dsk-mode. The default mode is topkmer,\n  which approximately counts most frequent kmers in the data. It can also runs\n  with dsk-mode. This command comes with more than a dozen options. Some of\n  options are only available to one of the two modes. Since topkmer-mode is\n  default, let us explain what options of the mode are. Use --kmer to choose\n  the size of K-mers to count in the input data. Set minimum or maximum counts\n  of kmers by using --lower-count or --upper-count, respectively. This command\n  creates table files; .tbl (TAB) and .tbh (TBH) files. TAB file is redirected\n  to STDOUT unless --outfile is given. Currently, the topkmer-mode is limited\n  upto two threads. By default, the topkmer-mode will use two threads. Change\n  the number of threads using --thread option. It will use as much memory as\n  available. Use --memory to change the size of memory. The more memory\n  available, the more accruate the count of kmers in the topkmer-mode. Use --nh\n  to set the size of a table, which would override the size of avilable memory\n  option. When FASTQ or FASTA sequence files are given to alder-kmer as STDIN,\n  use --format option to let alder-kmer know the format of the STDIN.\n  Currently, multiple format sequence data cannot be given as STDIN.\n\n  The dsk-mode in alder-kmer allows users to count kmers exactly. See Rizk et\n  al. 2013 for details of the algorithm. It uses disk space to count kmers.\n  Available disk space would determine the numbers of iterations, and maximum\n  memory would determine the number of partition files given the available disk\n  space. The alder-kmer attempts to compute the available disk space and memory\n  at the time the program runs. You could also specify disk space or available\n  memory. You can also specify directly the number of iterations and partitions\n  --ni and --np, these will override values that otherwise would be determined\n  by disk space and input sequence data; this is not recommended for real data.\n\n  To count kmers (K=2) in a sequence file, using option -k, type in:\n  $ count -k 2 a.fa\n  This would create an output file named outfile.tbl. Crate 10 fastq files and\n  count kmers in the files by typing in:\n  $ simulate -k 25 --maxkmer=100000 --nf=10 --progress\n  $ count -k 25 outfile*.fq\n\n  *** DUMP ***\n\n  This command takes a table file to create a text file with kmers. By default,\n  kmers are printed to STDOUT unless option --outfile is given. Two columns\n  separated by a tab character are printed out; kmer in DNA characters, and\n  count in numbers. Use option --fasta to print them in FASTA format; >count\n  newline kmer. Kmer sequences are printed in a line. Use --no-tab to separate\n  kmer and count by a space not a tab. You can use option --with-reverse to\n  print the reverse complementary sequence of each kmer; the first column is\n  kmer, the second column is its reverse complementary sequence, and the third\n  column is its number of occurences. In FASTA format output, the reverse\n  complementary sequence is printed just below each kmer sequence. The count\n  hash table contains index values for each kmer. The kmer index in a table can\n  be used to search fast at the expense of more memory space. Use option\n  --with-index to print the index of each kmer at the fourth column. In FASTA\n  format output, the index is printed to the right of the count value separated\n  by a space. Use --lower-count or --upper-count to limit the range of count\n  values in reporting kmer occurences.\n\n  This command would only the summary of kmer occurences with option --summary.\n\n  To display kmers and their occurences in a created hash table, type in:\n  $ dump outfile.tbl\n\n  *** SIMULATE ***\n\n  This command creates FASTQ files for testing alder-kmer. Use commands `list'\n  or `binary' to work with generated FASTQ files. There are no input files for\n  `simulate' command. By default, a sequence data would be written to STDOUT if\n  --nf option is given with 1 or a single sequence file is requested. Use\n  option --outfile or --nf with 2 or greater to write to files. Use --kmer to\n  specifiy the length of kmer sequences, and set the number of kmers using\n  --maxkmer. Change the length of sequences using option --seqlen.\n\n  The command can create FASTQ files with errors by using option --error-rate.\n  If the argument of option --error-rate is positive between 1 and 100, sets of\n  sequences are printed. A set of sequences contains as many kmers as specified\n  in option --maxkmer. Two kinds of sets of sequences are generated. The first\n  kind of sequence set contains random sequences. The number of sets in the\n  first kind is specified by option --error-initial. The second kind of\n  sequence set are repeated as many time as specified by option\n  --error-iteration. Options --error-initial and --error-iteration take effect\n  only if option --error-rate is given with an argument of positive number.\n\n  To generate a sequence file using `simulate' command, type in:\n  $ simulate\n\n  To generate a set of sequences with 30 kmers of size 5 at random, and another\n  set of the same size of sequences twice with error rate 1%, type in:\n  $ simulate --kmer=5 --maxkmer=30 --error-rate=1 --error-iteration=2\n  --error-initial=1\n\n  The command `simulate' can only create a small-size data set because it would\n  take too much time to generate a large data set. You could bump up a file\n  using the following commands:\n\n  $ for i in {1..10}; do echo outfile-00.fq; done | xargs cat > outfile.fq\n\n  Use optoins --seed to reproduce the same data.\n\n  *** LIST ***\n\n  This command simply reads FASTQ sequence files, and prints one kmer sequence\n  per line.\n\n  To generate a FASTQ file with 10 kmers of size 1, and to list kmers in the\n  FASTQ file, type in:\n  $ simulate --maxkmer=10 > 1.fq\n  $ list 1.fq\n\n  *** BINARY ***\n\n  To create a binary file from a set of FASTQ files, type in:\n  $ simulate -k 25 --maxkmer=1000000 --nf=10 --progress\n  $ binary *.fq\n\n  *** VIEW ***\n\n  This command allows users to view the content of binary files. Use option\n  --format to set the format of input files.\n\n\n  To view binary files, use option `--format=bin' with bin input files. This\n  command then converts alder-kmer binary sequence files to a simple form of\n  sequence file. Without --outfile option, the output goes to STDOUT. With\n  --outfile option, a file with extension of .seq is created. This could be use\n  to compare a binary file from FASTQ files.\n\n  $ simulate > file.fq\n  $ binary file.fq\n  $ view --format=bin outfile.bin > file-bin.seq\n  $ awk 'NR % 4 == 2' file.fq > file.seq\n  $ diff file.seq\n\n  Use command-line tool `md5' to compare two files because files can be large.\n\n  To view kmers in par files, use options `--format=par' with par input files.\n  This command then converts a partition file to a kmer sequence file. Because\n  partition files do not have a field of kmer size, set the kmer size to use\n  this command. Use the following commands to convert the decoded kmers to a\n  dumped table. Try to type in:\n\n  $ simulate > file.fq\n  $ binary file.fq\n  $ partition outfile.bin\n  $ view --format=par outfile-0-0.par > outfile.dec\n\n  To tabulate the count C or T at the first column in outfile.dec, type in:\n  $ cut -f 1 outfile.dec|sort|uniq -c|awk 'BEGIN{OFS=FS=\" \"}\n  {tmp=$1;$1=$2;$2=tmp;print}'\n\n  *** PARTITION ***\n\n  To convert a binary file to partition files, type in:\n\n  $ simulate > file.fq\n  $ binary file.fq\n  $ partition outfile.bin\n\n  *** TABLE ***\n\n  To convert partition files to a table file, type to type in:\n\n  $ simulate > file.fq\n  $ binary file.fq\n  $ partition outfile.bin\n  $ table outfile-0-0.par\n\n  You could compare the content of the partition file and the table file using\n  the following commands:\n\n  $ view --format=par outfile-0-0.par > outfile.dec\n  $ cut -f 1 outfile.dec|sort|uniq -c|awk 'BEGIN{OFS=FS=\" \"}\n  {tmp=$1;$1=$2;$2=tmp;print}'\n  $ dump --dsk outfile.tbl\n\n  *** MATCH ***\n\n  This command compares an exactly counted table with an approximated counted\n  file. This command can be used to check whether the exactly counted table\n  contains all of the kmers in the sequence files. It is also used to check\n  whether .kmc files contains all of the kmers in the exactly counted table.\n\n  Use the following commands to create a FASTQ file, and count kmers using\n  either dsk mode or topkmer mode:\n  $ s -k 10 --maxkmer=2000000 --error-rate=1 --outfile=outfile --seed=1\n  $ mv outfile-00.fq outfile.fq\n  $ count -k 10 --dsk --memory=200 outfile.fq --outfile=dsk\n  $ count --outfile=outfile -k 20 --nh=500 --nthread=1 outfile.fq --save-all\n  $ match --tabfile=dsk.tbl --format=kmc outfile-deleted.kmc outfile-saved.kmc\n\n  The final command `match' does not produce any output if the topkmer also\n  counted all of the kmers correctly.\n\n  To compare a table and a set of sequence files, type in:\n  $ match --tabfile=outfile.tbl outfile-0-0.fq\n\n  *** ASSESS ***\n\n  This command compares an exactly counted table with an approximately counted\n  one, and assesses errors and accuracy of the approximately counted table. Use\n  option --tabfile with an exactly counted table file name. The input file is\n  an approximately counted table. For each kmer in an exactly counted table,\n  first check if the count value is greater than a given minimum value. If so,\n  I compute (x - y)/x where x is the exact count, and y is the approximately\n  counted value. I also increment the total number of kmers whose exact count\n  is greater than a given minimum value. I choose a range of minimum values. A\n  desirable tendency would be that errors decrease as the given minimum value\n  increases.\n\n  This command compares the exactly counted kmers and the approximately counted\n  ones to assess the error rate in the approximately counted ones. After\n  execute commands in the command match example, and type in:\n  $ assess --tabfile=dsk.tbl outfile.tbl\n\n  It prints the minimum count, error rate, and total number of kmers with count\n  at least the minimum count:\n  error [1]: 1.000 (524507)\n  .\n  error [10]: 0.999 (124780)\n\n  *** INSPECT ***\n\n  To inspect your computer, type in:\n  $ inspect\n\n  *** QUERY ***\n\n  !!! NOT WORKING YET !!!\n  $ query\n\n  *** EXAMPLES ***\n\n  Let's consider these variables in testing.\n  K: kmer size\n  N: number of unique kmers (MAX of N=10^8)\n  F: occurence of each unique kmer\n  T: number of threads\n  D: disk space\n  M: memory required\n\n  1. Simple test\n\n  2. Count command test (.fa/.fq -> .tbl)\n  K=15..200,T=1,N=1000,F=65535,D=100,M=10\n  for K in {15..200}; do ./count $K 1000 65535 fq no 100 10 1; done\n  K=15..200,T=2\n  for K in {15..200}; do ./count $K 1000 65535 fq no 100 10 2; done\n  K=15..200,T=4\n  for K in {15..200}; do ./count $K 1000 65535 fq no 100 10 4; done\n\n  *** FEATURES ****\n\n  alder-kmer can:\n\n  deal with input sequence files including FASTA and FASTQ files whether they\n  are compressed with gzip or not,\n\n  handle multiple sequence files as in typical unix command,\n\n  count kmers using dsk-mode or topkmer-mode,\n\n  set the minimum or maximum values of counts,\n\n  provide frequency of counts,\n\n  *** TODO ***\n\n  . Test of overflow of occurence (create a separate file of kmer of\n  overflowed).\n  ### End of Examples ###",
  ...
  "      --document                Shows the document for alder-kmer\n                                  (default=off)",
    0
};
static void
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[100] = gengetopt_args_info_detailed_help[101];
  gengetopt_args_info_full_help[101] = gengetopt_args_info_detailed_help[102];
  gengetopt_args_info_full_help[102] = gengetopt_args_info_detailed_help[103];
  gengetopt_args_info_full_help[103] = gengetopt_args_info_detailed_help[104];
  gengetopt_args_info_full_help[104] = gengetopt_args_info_detailed_help[105];
  gengetopt_args_info_full_help[105] = gengetopt_args_info_detailed_help[106];
  gengetopt_args_info_full_help[106] = gengetopt_args_info_detailed_help[107];
  gengetopt_args_info_full_help[107] = gengetopt_args_info_detailed_help[108];
  gengetopt_args_info_full_help[108] = gengetopt_args_info_detailed_help[109];
  gengetopt_args_info_full_help[109] = gengetopt_args_info_detailed_help[110];
  gengetopt_args_info_full_help[110] = gengetopt_args_info_detailed_help[111];
  gengetopt_args_info_full_help[111] = gengetopt_args_info_detailed_help[112];
  gengetopt_args_info_full_help[112] = gengetopt_args_info_detailed_help[113];
  gengetopt_args_info_full_help[113] = gengetopt_args_info_detailed_help[114];
  gengetopt_args_info_full_help[114] = gengetopt_args_info_detailed_help[115];
  gengetopt_args_info_full_help[115] = gengetopt_args_info_detailed_help[116];
  gengetopt_args_info_full_help[116] = gengetopt_args_info_detailed_help[117];
  gengetopt_args_info_full_help[117] = 0; 
  
}

const char *gengetopt_args_info_full_help[118];
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[99] = gengetopt_args_info_detailed_help[101];
  gengetopt_args_info_help[100] = gengetopt_args_info_detailed_help[102];
  gengetopt_args_info_help[101] = gengetopt_args_info_detailed_help[103];
  gengetopt_args_info_help[102] = gengetopt_args_info_detailed_help[104];
  gengetopt_args_info_help[103] = gengetopt_args_info_detailed_help[105];
  gengetopt_args_info_help[104] = gengetopt_args_info_detailed_help[106];
  gengetopt_args_info_help[105] = gengetopt_args_info_detailed_help[107];
  gengetopt_args_info_help[106] = gengetopt_args_info_detailed_help[108];
  gengetopt_args_info_help[107] = gengetopt_args_info_detailed_help[109];
  gengetopt_args_info_help[108] = gengetopt_args_info_detailed_help[110];
  gengetopt_args_info_help[109] = gengetopt_args_info_detailed_help[111];
  gengetopt_args_info_help[110] = gengetopt_args_info_detailed_help[112];
  gengetopt_args_info_help[111] = gengetopt_args_info_detailed_help[113];
  gengetopt_args_info_help[112] = gengetopt_args_info_detailed_help[114];
  gengetopt_args_info_help[113] = gengetopt_args_info_detailed_help[115];
  gengetopt_args_info_help[114] = gengetopt_args_info_detailed_help[116];
  gengetopt_args_info_help[115] = gengetopt_args_info_detailed_help[117];
  gengetopt_args_info_help[116] = 0; 
  
}

const char *gengetopt_args_info_help[117];
...
const char *my_cmdline_parser_format_values[] = {"fasta", "fastq", "fa", "fq", "seq", "kmc", "tbl", "tbh", "par", "bin", 0}; /*< Possible values for format. */
const char *my_cmdline_parser_loglevel_values[] = {"0", "1", "2", "3", "4", "5", 0}; /*< Possible values for loglevel. */
const char *my_cmdline_parser_select_version_values[] = {"0", "1", "2", "3", "4", "5", "7", "8", 0}; /*< Possible values for select-version. */
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->nsplit_given = 0 ;
  args_info->use_seqfile_given = 0 ;
  args_info->binfile_given = 0 ;
  args_info->parfile_given = 0 ;
  args_info->error_initial_given = 0 ;
  args_info->error_rate_given = 0 ;
  args_info->error_iteration_given = 0 ;
  args_info->error_duplicate_given = 0 ;
  args_info->dsk_given = 0 ;
  args_info->assess_given = 0 ;
  args_info->save_all_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->tabfile_arg = gengetopt_strdup ("outfile");
  ...
  args_info->select_version_arg = 8;
  ...
  args_info->nsplit_arg = 1;
  args_info->nsplit_orig = NULL;
  args_info->use_seqfile_flag = 0;
  args_info->binfile_arg = gengetopt_strdup ("outfile");
  args_info->binfile_orig = NULL;
  args_info->parfile_arg = gengetopt_strdup ("outfile");
  args_info->parfile_orig = NULL;
  args_info->error_initial_arg = 1;
  args_info->error_initial_orig = NULL;
  args_info->error_rate_arg = 0;
  args_info->error_rate_orig = NULL;
  args_info->error_iteration_arg = 1;
  args_info->error_iteration_orig = NULL;
  args_info->error_duplicate_arg = 1;
  args_info->error_duplicate_orig = NULL;
  args_info->dsk_flag = 0;
  args_info->assess_flag = 0;
  args_info->save_all_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->nsplit_help = gengetopt_args_info_detailed_help[91] ;
  args_info->use_seqfile_help = gengetopt_args_info_detailed_help[92] ;
  args_info->binfile_help = gengetopt_args_info_detailed_help[93] ;
  args_info->parfile_help = gengetopt_args_info_detailed_help[94] ;
  args_info->error_initial_help = gengetopt_args_info_detailed_help[95] ;
  args_info->error_rate_help = gengetopt_args_info_detailed_help[96] ;
  args_info->error_iteration_help = gengetopt_args_info_detailed_help[97] ;
  args_info->error_duplicate_help = gengetopt_args_info_detailed_help[98] ;
  args_info->dsk_help = gengetopt_args_info_detailed_help[99] ;
  args_info->assess_help = gengetopt_args_info_detailed_help[102] ;
  args_info->save_all_help = gengetopt_args_info_detailed_help[103] ;
  args_info->view_help = gengetopt_args_info_detailed_help[106] ;
  args_info->fastq_help = gengetopt_args_info_detailed_help[107] ;
  args_info->release_help = gengetopt_args_info_detailed_help[108] ;
  args_info->exit_help = gengetopt_args_info_detailed_help[111] ;
  args_info->examples_help = gengetopt_args_info_detailed_help[114] ;
  args_info->document_help = gengetopt_args_info_detailed_help[117] ;
...
my_cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->nsplit_orig));
  free_string_field (&(args_info->binfile_arg));
  free_string_field (&(args_info->binfile_orig));
  free_string_field (&(args_info->parfile_arg));
  free_string_field (&(args_info->parfile_orig));
  free_string_field (&(args_info->error_initial_orig));
  free_string_field (&(args_info->error_rate_orig));
  free_string_field (&(args_info->error_iteration_orig));
  free_string_field (&(args_info->error_duplicate_orig));
...
my_cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->nsplit_given)
    write_into_file(outfile, "nsplit", args_info->nsplit_orig, 0);
  if (args_info->use_seqfile_given)
    write_into_file(outfile, "use-seqfile", 0, 0 );
  if (args_info->binfile_given)
    write_into_file(outfile, "binfile", args_info->binfile_orig, 0);
  if (args_info->parfile_given)
    write_into_file(outfile, "parfile", args_info->parfile_orig, 0);
  if (args_info->error_initial_given)
    write_into_file(outfile, "error-initial", args_info->error_initial_orig, 0);
  if (args_info->error_rate_given)
    write_into_file(outfile, "error-rate", args_info->error_rate_orig, 0);
  if (args_info->error_iteration_given)
    write_into_file(outfile, "error-iteration", args_info->error_iteration_orig, 0);
  if (args_info->error_duplicate_given)
    write_into_file(outfile, "error-duplicate", args_info->error_duplicate_orig, 0);
  if (args_info->dsk_given)
    write_into_file(outfile, "dsk", 0, 0 );
  if (args_info->assess_given)
    write_into_file(outfile, "assess", 0, 0 );
  if (args_info->save_all_given)
    write_into_file(outfile, "save-all", 0, 0 );
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "nsplit",	1, NULL, 0 },
        { "use-seqfile",	0, NULL, 0 },
        { "binfile",	1, NULL, 0 },
        { "parfile",	1, NULL, 0 },
        { "error-initial",	1, NULL, 0 },
        { "error-rate",	1, NULL, 0 },
        { "error-iteration",	1, NULL, 0 },
        { "error-duplicate",	1, NULL, 0 },
        { "dsk",	0, NULL, 0 },
        { "assess",	0, NULL, 0 },
        { "save-all",	0, NULL, 0 },
        { "view",	0, NULL, 0 },
      ...
      switch (c)
        ...
        case 'h':	/* Print help of the program, or a command: e.g., alder-kmer count -h.  */
          ...
          break;
        case 'k':	/* k-mer size (same: -m/--mer-len).  */
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "nh") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->nh_arg), 
                ...
                &(local_args_info.nh_given), optarg, 0, "0", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "nh", '-',
                additional_error))
              goto failure;
          ...
          /* Display only summary of the table.  */
          ...
          else if (strcmp (long_options[option_index].name, "tabfile") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->tabfile_arg), 
                ...
                &(local_args_info.tabfile_given), optarg, 0, "outfile", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "tabfile", '-',
                additional_error))
              goto failure;
          ...
          /* Select a version of kmer counting: 0 for automatic selction, 1 for skipping binary file creation (dsk mode with a single iteration), 2 for binary file creation (dsk mode), 3 for loading a whole input data on the memory (msk or memory streaming kmer mode), 4 for splitting a binary file, 5 for distributed reading, 7 for sequential read with CAS encoding, and 8 for space saving algorithm..  */
          else if (strcmp (long_options[option_index].name, "select-version") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->select_version_arg), 
                ...
                &(local_args_info.select_version_given), optarg, my_cmdline_parser_select_version_values, "8", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "select-version", '-',
                additional_error))
              goto failure;
          ...
          /* split binary files.  */
          else if (strcmp (long_options[option_index].name, "nsplit") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->nsplit_arg), 
                 &(args_info->nsplit_orig), &(args_info->nsplit_given),
                &(local_args_info.nsplit_given), optarg, 0, "1", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "nsplit", '-',
                additional_error))
              goto failure;
          ...
          /* Use FASTQ or FASTA.  */
          else if (strcmp (long_options[option_index].name, "use-seqfile") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->use_seqfile_flag), 0, &(args_info->use_seqfile_given),
                &(local_args_info.use_seqfile_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "use-seqfile", '-',
                additional_error))
              goto failure;
          
          }
          /* prefix of binary files.  */
          else if (strcmp (long_options[option_index].name, "binfile") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->binfile_arg), 
                 &(args_info->binfile_orig), &(args_info->binfile_given),
                &(local_args_info.binfile_given), optarg, 0, "outfile", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "binfile", '-',
                additional_error))
              goto failure;
          ...
          /* prefix of partition files.  */
          else if (strcmp (long_options[option_index].name, "parfile") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->parfile_arg), 
                 &(args_info->parfile_orig), &(args_info->parfile_given),
                &(local_args_info.parfile_given), optarg, 0, "outfile", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "parfile", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "error-initial") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->error_initial_arg), 
                 &(args_info->error_initial_orig), &(args_info->error_initial_given),
                &(local_args_info.error_initial_given), optarg, 0, "1", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "error-initial", '-',
                additional_error))
              goto failure;
          ...
          /* error rate in per cent.  */
          else if (strcmp (long_options[option_index].name, "error-rate") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->error_rate_arg), 
                 &(args_info->error_rate_orig), &(args_info->error_rate_given),
                &(local_args_info.error_rate_given), optarg, 0, "0", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "error-rate", '-',
                additional_error))
              goto failure;
          ...
          /* number of sets with errors.  */
          else if (strcmp (long_options[option_index].name, "error-iteration") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->error_iteration_arg), 
                 &(args_info->error_iteration_orig), &(args_info->error_iteration_given),
                &(local_args_info.error_iteration_given), optarg, 0, "1", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "error-iteration", '-',
                additional_error))
              goto failure;
          ...
          /* max number of sets with the same errors.  */
          else if (strcmp (long_options[option_index].name, "error-duplicate") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->error_duplicate_arg), 
                 &(args_info->error_duplicate_orig), &(args_info->error_duplicate_given),
                &(local_args_info.error_duplicate_given), optarg, 0, "1", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "error-duplicate", '-',
                additional_error))
              goto failure;
          ...
          /* Turn on DSK mode.  */
          else if (strcmp (long_options[option_index].name, "dsk") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->dsk_flag), 0, &(args_info->dsk_given),
                &(local_args_info.dsk_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "dsk", '-',
                additional_error))
              goto failure;
          
          }
          /* assess command.  */
          else if (strcmp (long_options[option_index].name, "assess") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->assess_flag), 0, &(args_info->assess_given),
                &(local_args_info.assess_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "assess", '-',
                additional_error))
              goto failure;
          
          }
          /* Save deleted keys.  */
          else if (strcmp (long_options[option_index].name, "save-all") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->save_all_flag), 0, &(args_info->save_all_given),
                &(local_args_info.save_all_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "save-all", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "view") == 0)
          {
            ...
            if (update_arg((void *)&(args_info->view_flag), 0, &(args_info->view_given),
                ...
                check_ambiguity, override, 1, 0, "view", '-',
                additional_error))
              goto failure;
          
          }
          /* in fastq format.  */
          else if (strcmp (long_options[option_index].name, "fastq") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->fastq_flag), 0, &(args_info->fastq_given),
                &(local_args_info.fastq_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "fastq", '-',
                additional_error))
              goto failure;
