...
const char *gengetopt_args_info_purpose = "alder-kmer counts kmers in a data set of FASTQ and FASTA sequence files.";

const char *gengetopt_args_info_usage = "Usage: alder-kmer [command] [OPTIONS]... [FILES]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "alder-kmer counts kmers exactly using DSK algorithm (Rizk et al. 2013) or\napproximately using a space-saving algorithm. It allows arbitrary size of\nkmers. The first argument of the alder-kmer is a command, which is one of the\nfollowing strings: `count', `dump', `query', `simulate', `partition', `kmer',\n`table', `list', `match', `binary', `uncompress', `inspect', and `example'. Use\noption --help to see more options for each command; e.g., alder-kmer count\n--help. Options may require arguments. `INT' is a positive number unless stated\notherwise. `STRING' is a string of characters. `FILENAME' and `DIRECTORY' are\nstrings that could be found or created in the file system that you run\nalder-kmer on.";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "      --fasta                   kmers listted in fasta format  (default=off)",
  ...
  "      --format=STRING           sequence file format  (possible\n                                  values=\"fasta\", \"fastq\", \"fa\", \"fq\",\n                                  \"seq\" default=`fastq')",
  ...
  "\nlist:",
  "  This command lists kmer sequences in a fastq file. Kmer sequences should have\n  the four letters of A, C, G, and T (a, c, g, or t). Any other characters are\n  considered not a valid DNA letter. Invalid characters would end a sequence,\n  and let the command restart a new sequence if there are more DNA letters that\n  follow. Available options include kmer. It does not check the content of a\n  FASTQ file, and may have side-effects if other formats are provided. It reads\n  STDIN or a file. If option --outfile is used, a file with .lst extension is\n  created instead of being sent to STDOUT",
  "      --list                    List kmers in a text file. Options: kmer,\n                                  seqlen  (default=off)",
  "\nmatch:",
  "  NOT WORKING or BUGs - This command compares a table file and a set of input\n  files. A set of sequence data can be given as either standard input or input\n  files.",
  "      --match                   Compare a table file and input sequence data.\n                                  (default=off)",
  "      --tabfile=STRING          a table file name  (default=`outfile')",
  "\nbinary:",
  "  This command converts sequence files to a alder-kmer binary file. Use command\n  uncompress to decode a binary file.",
  ...
  "      --error-rate=INT          error rate in per cent  (default=`0')",
...
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[112] = 0; 
  
}

const char *gengetopt_args_info_full_help[113];
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[111] = 0; 
  
}

const char *gengetopt_args_info_help[112];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->release_help = gengetopt_args_info_detailed_help[103] ;
  args_info->exit_help = gengetopt_args_info_detailed_help[106] ;
  args_info->examples_help = gengetopt_args_info_detailed_help[109] ;
  args_info->document_help = gengetopt_args_info_detailed_help[112] ;
