/**
 * This file, alder_kmer_encode4.h, is part of alder-kmer.
 *
...
#ifndef alder_kmer_alder_kmer_encode4_h
#define alder_kmer_alder_kmer_encode4_h
...
enum {
    ALDER_KMER_ENCODER4_READER_UNLOCK      = 9,
    ALDER_KMER_ENCODER4_READER_LOCK        = 10,
    ALDER_KMER_ENCODER4_READER_RELEASE     = 11,
    ALDER_KMER_ENCODER4_WRITER_UNLOCK      = 12,
    ALDER_KMER_ENCODER4_WRITER_LOCK        = 13,
    ALDER_KMER_ENCODER4_WRITER_RELEASE     = 14
};

typedef struct alder_kmer_encoder4_struct alder_kmer_encoder4_t;

/* Readwriter thread accesses this type.
 */
struct alder_kmer_encoder4_struct {
    /* info */
    int k;                     /* k - kmer size                              */
...
void alder_kmer_encoder4_lock_reader(alder_kmer_encoder4_t *a, int encoder_id);
void alder_kmer_encoder4_unlock_reader(alder_kmer_encoder4_t *a, int encoder_id);
void alder_kmer_encoder4_lock_writer(alder_kmer_encoder4_t *a, int part_id);
void alder_kmer_encoder4_unlock_writer(alder_kmer_encoder4_t *a, int part_id);

__END_DECLS


#endif /* alder_kmer_alder_kmer_encode4_h */
