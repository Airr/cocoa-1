/**
 * This file, alder_kmer_thread4.h, is part of alder-kmer.
 *
...
#ifndef alder_kmer_alder_kmer_thread4_h
#define alder_kmer_alder_kmer_thread4_h
...
enum {
    ALDER_KMER_COUNTER4_READER_UNLOCK      = 9,
    ALDER_KMER_COUNTER4_READER_LOCK        = 10,
    ALDER_KMER_COUNTER4_READER_RELEASE     = 11,
    ALDER_KMER_COUNTER4_WRITER_UNLOCK      = 12,
    ALDER_KMER_COUNTER4_WRITER_LOCK        = 13,
    ALDER_KMER_COUNTER4_WRITER_RELEASE     = 14
};

#pragma mark struct

typedef struct alder_kmer_thread4_struct
alder_kmer_thread4_t;

/* Readwriter thread accesses this type.
 */
struct alder_kmer_thread4_struct {
    /* info */
    int k;                       /* k - kmer size                            */
...
#endif /* alder_kmer_alder_kmer_thread4_h */
