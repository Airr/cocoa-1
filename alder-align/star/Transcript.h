...
class Transcript {
    public:
        //uint rMM[MAX_READ_LENGTH]; //read-space MM coordinates. TODO: remove? reduce the size, do not save the whole array
//         uint gMap[MAX_READ_LENGTH]; //map read bases to genome. TODO: allocate with smaller size
