...
//     statsRA=new StatsAll;
    ...
    //read
    Read0 = new char*[2];    
    Read0[0]  = new char [MAX_READ_LENGTH+1];
    Read0[1]  = new char [MAX_READ_LENGTH+1];

    Qual0 = new char*[2];
    Qual0[0]  = new char [MAX_READ_LENGTH+1];
    Qual0[1]  = new char [MAX_READ_LENGTH+1];

    readNameMates=new char* [P->readNmates];
    for (uint ii=0; ii<P->readNmates; ii++) readNameMates[ii]=new char [MAX_READ_NAME_LENGTH];
    
    readName = readNameMates[0];
    Read1 = new char*[3];
    Read1[0]=new char[MAX_READ_LENGTH+1]; Read1[1]=new char[MAX_READ_LENGTH+1]; Read1[2]=new char[MAX_READ_LENGTH+1];    
    Qual1=new char*[2]; //modified QSs for scoring
    Qual1[0]=new char[MAX_READ_LENGTH+1]; Qual1[1]=new char[MAX_READ_LENGTH+1];
