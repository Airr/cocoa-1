...
int bam_is_be = 0, bam_verbose = 0, bam_no_B = 0;
...
bam_header_t *bam_header_read(bamFile fp)
{
	...
	// read "BAM1"
	magic_len = (int)bam_read(fp, buf, 4);
...
int bam_read1(bamFile fp, bam1_t *b)
{
	...
	if ((ret = (int32_t)bam_read(fp, &block_len, 4)) != 4) {
...
int bam_remove_B(bam1_t *b)
{
	...
	b->data_len = (int)(p - b->data); // update record length
	return 0;
