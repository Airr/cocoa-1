...
/*
 Aug 09 20:55:54 ..... Started STAR run
 Aug 09 20:55:54 ... Starting to generate Genome files
 Aug 09 20:55:54 ... starting to sort  Suffix Array. This may take a long time...
 Aug 09 20:55:54 ... sorting Suffix Array chunks and saving them to disk...
 Aug 09 20:55:54 ... loading chunks from disk, packing SA...
 Aug 09 20:55:54 ... writing Suffix Array to disk ...
 Aug 09 20:55:54 ... Finished generating suffix array
 Aug 09 20:55:54 ... starting to generate Suffix Array index...
 Aug 09 20:55:59 ... writing SAindex to disk
 Aug 09 20:56:03 ..... Finished successfully
 */
...
void genomeGenerate(Parameters *P)
{
    ...
    time(&rawTime);
    fprintf(stdout, "%s ... Starting to generate Genome files\n", asctime (localtime (&timing)));
    ...
    if (P->limitGenomeGenerateRAM<N2*2) {//
        ostringstream errOut;
        errOut <<"EXITING because of FATAL PARAMETER ERROR: limitGenomeGenerateRAM="<< (P->limitGenomeGenerateRAM>>30) <<"is too small for your genome\n";
        errOut <<"SOLUTION: please specify limitGenomeGenerateRAM not less than"<< ((N2*2)>>30)+1 <<" GB and make that much RAM available \n";
        exitWithError(errOut.str(),std::cerr, P->inOut->logMain, EXIT_CODE_INPUT_FILES, *P);
    };
