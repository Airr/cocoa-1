/**
 * This file, alder_fasta_cat.h, is part of alder-fasta.
 *
...
#ifndef alder_fasta_alder_fasta_cat_h
#define alder_fasta_alder_fasta_cat_h
...
// Print sequence name, and positions in a single concatenated sequence.
int alder_fasta_cat(struct bstrList *fs, struct bstrList *ofs);

__END_DECLS


#endif /* alder_fasta_alder_fasta_cat_h */
