...
@interface XFFileOperationQueue ()

/**
 * Creates a path that consists of the directory and the file name.
 */
- (NSString*)destinationPathFor:(NSString*)fileName inProjectDirectory:(NSString*)directory;

/**
 * Writes each content in the queue to the corresponding path.
 */
...
/**
 * Deletes files in reverse order.
 */
...
@implementation XFFileOperationQueue
