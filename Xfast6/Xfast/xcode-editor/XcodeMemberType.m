    ...
    dispatch_once(&onceToken,
                  ^{
                      ...
                      [[NSDictionary alloc] initWithObjectsAndKeys:
                       ...
                       @(PBXOutFileReferenceType),        @"PBXOutFileReference",
                       ...
                       @(XCConfigurationListType),     @"XCConfigurationList",
                       @(XFPBXNilType),                  @"XFPBXNilType",
                       @(XFPBXBuildFileType),            @"XFPBXBuildFile",
                       @(XFPBXFontainerItemProxyType),   @"XFPBXFontainerItemProxy",
                       @(XFPBXFopyFilesBuildPhaseType),  @"XFPBXFopyFilesBuildPhase",
                       @(XFPBXFileReferenceType),        @"XFPBXFileReference",
                       @(XFPBXOutFileReferenceType),        @"XFPBXOutFileReference",
                       @(XFPBXFrameworksBuildPhaseType), @"XFPBXFrameworksBuildPhase",
                       @(XFPBXGroupType),                @"XFPBXGroup",
                       @(XFPBXNativeTargetType),         @"XFPBXNativeTarget",
                       @(XFPBXProjectType),              @"XFPBXProject",
                       @(XFPBXReferenceProxyType),       @"XFPBXReferenceProxy",
                       @(XFPBXResourcesBuildPhaseType),  @"XFPBXResourcesBuildPhase",
                       @(XFPBXSourcesBuildPhaseType),    @"XFPBXSourcesBuildPhase",
                       @(XFPBXOutputBuildPhaseType),     @"XFPBXOutputBuildPhase",
                       @(XFPBXTargetDependencyType),     @"XFPBXTargetDependency",
                       @(XFPBXVariantGroupType),         @"XFPBXVariantGroup",
                       @(XFBuildConfigurationType),      @"XFBuildConfiguration",
                       @(XFConfigurationListType),       @"XFConfigurationList",
                       nil
                       ];
                  }
                  );
