...
# define FinalizeMemory		Rf_FinalizeMemory
# define FinalizeNames		Rf_FinalizeNames
# define freeVector		Rf_freeVector
...
void FinalizeNames(void);
void freeVector(SEXP);
