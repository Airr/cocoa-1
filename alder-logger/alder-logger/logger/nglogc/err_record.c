      ...
      )
{
   ...
   if (rec->file == NULL) {
      recordSize = (int)(strlen(rec->formatStr) + strlen(err) +  2);
   } else {
      flf = LOG_TRUE;
      ...
      )
{
   ...
   if (rec->file == NULL) {
      recordSize = (int)(strlen(rec->formatStr) + strlen(err) + strlen(tag) + 2);
   } else {
      flf = LOG_TRUE;
      recordSize = (int)(strlen(rec->file) + MAX_INT + strlen(rec->function) +
      ...
      )
{
   ...
   if (rec->file == NULL) {
      recordSize = (int)(strlen(rec->formatStr) + strlen(err) +
      ...
      )
{
   ...
   if (rec->file == NULL) {
   recordSize = (int)(strlen(rec->formatStr) + strlen(timest) +
